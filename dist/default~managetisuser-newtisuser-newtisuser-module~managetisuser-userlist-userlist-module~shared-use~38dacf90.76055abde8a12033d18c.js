(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~managetisuser-newtisuser-newtisuser-module~managetisuser-userlist-userlist-module~shared-use~38dacf90"],{
...
/***/ "./src/app/shared/model/AuthAttributes.ts":
/*!************************************************!*\
  !*** ./src/app/shared/model/AuthAttributes.ts ***!
  \************************************************/
/*! exports provided: AuthAttributes */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AuthAttributes", function() { return AuthAttributes; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");

var AuthAttributes = /** @class */ (function () {
...
/***/ "./src/app/shared/model/AuthResponse.ts":
/*!**********************************************!*\
  !*** ./src/app/shared/model/AuthResponse.ts ***!
  \**********************************************/
/*! exports provided: AuthResponse */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AuthResponse", function() { return AuthResponse; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _AuthAttributes__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./AuthAttributes */ "./src/app/shared/model/AuthAttributes.ts");
/* harmony import */ var _utils_constants__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../utils/constants */ "./src/app/shared/utils/constants.ts");
...
var AuthResponse = /** @class */ (function () {
    ...
    */
    function AuthResponse(currentUserInfo) {
        ...
        /**Set flag to hide/display add user button after validating permissions. */
        this.hasAddPermissions = false;
        this.findUserAttributes(currentUserInfo);
    }
    /**
    * Method to find permission and toc keys and set the attributes.
    * @param currentUserInfo
    * @returns - AuthResponse object
    */
    AuthResponse.prototype.findUserAttributes = function (currentUserInfo) {
        var authAttributes = new _AuthAttributes__WEBPACK_IMPORTED_MODULE_1__["AuthAttributes"]();
        // Array to store all user related keys.
        var userInfoKeys;
        // Array to hold values for user attribute keys.
        var valuesArray;
        // Array to find and check user attribute keys.
        var attributeKeys;
        /**Array to store permission values. */
        var permissionsArray;
        userInfoKeys = Object.keys(currentUserInfo);
        for (var i = 0; i < userInfoKeys.length; i++) {
            if (userInfoKeys[i] == _utils_constants__WEBPACK_IMPORTED_MODULE_2__["Constants"].ATTRIBUTES_FIELD) {
                valuesArray = currentUserInfo[userInfoKeys[i]];
                attributeKeys = Object.keys(valuesArray);
                for (var j = 0; j < attributeKeys.length; j++) {
                    if (attributeKeys[j] == (_utils_constants__WEBPACK_IMPORTED_MODULE_2__["Constants"].CUSTOM_TOC)) {
                        authAttributes.customToc = valuesArray[attributeKeys[j]];
                        this.defaultToc = authAttributes.customToc;
                    }
                    if (attributeKeys[j] == (_utils_constants__WEBPACK_IMPORTED_MODULE_2__["Constants"].CUSTOM_PERMISSIONS_FIELD)) {
                        authAttributes.customPermissions = valuesArray[attributeKeys[j]];
                        // Validate for permissions here and set class variables.
                        permissionsArray = authAttributes.customPermissions.
                            split(_utils_constants__WEBPACK_IMPORTED_MODULE_2__["Constants"].SPLIT_PIPE_FOR_PERMISSIONS);
                        for (var j_1 = 0; j_1 < permissionsArray.length; j_1++) {
                            if (permissionsArray[j_1] ==
                                _utils_constants__WEBPACK_IMPORTED_MODULE_2__["Constants"].ADD_USER_PERMISSION_VALUE) {
                                this.hasAddPermissions = true;
                            }
                            else if (permissionsArray[j_1] ==
                                _utils_constants__WEBPACK_IMPORTED_MODULE_2__["Constants"].EDIT_USER_PERMISSION_VALUE) {
                                this.hasEditPermissions = true;
                            }
                            else if (permissionsArray[j_1] ==
                                _utils_constants__WEBPACK_IMPORTED_MODULE_2__["Constants"].DELETE_USER_PERMISSION_VALUE) {
...
//# sourceMappingURL=default~managetisuser-newtisuser-newtisuser-module~managetisuser-userlist-userlist-module~shared-use~38dacf90.76055abde8a12033d18c.js.map